                                ...
                                while ($row = mysqli_fetch_array($resultadoProducto)) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td nowrap>
                                            ...
                                            <a href="updateProduct.php?id=<?= $row["idProductos"] ?>" class="btn btn-warning btn-sm">Edit</a>

                                            <a href="deleteProduct.php?id=<?= $row["idProductos"] ?>" class="btn btn-danger btn-sm">Delete</a>
